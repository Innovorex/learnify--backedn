-- Progress Analytics - Working Version with Explicit Casts
...
SELECT 'DATABASE MIGRATION SUCCESSFUL!' as status, COUNT(*) as teacher_count FROM teacher_current_scores;
SELECT teacher_name, overall_score, cpd_score, career_score, student_impact_score FROM teacher_current_scores LIMIT 5;
